...
Source - https://github.com/novuhq/novu-python/blob/main/novu/enums/provider.py
"""
from enum import Enum
from typing import Union


class CredentialsKeyEnum(str, Enum):
...
class EmailProviderIdEnum(str, Enum):
...
class SmsProviderIdEnum(str, Enum):
...
class ChatProviderIdEnum(str, Enum):
...
class PushProviderIdEnum(str, Enum):
...
class InAppProviderIdEnum(str, Enum):
